...
def train_awa_vae(dataset="gym_fetch", z_dim=64, batch_size=32, num_epochs=250, beta_kl=1.0, beta_rec=0.0, beta_task=1.0, weight_cross_penalty=0.1, 
                 device=0, save_interval=30, lr=2e-4, seed=0, vae_model="CNNBasedVAE", width=448, height=448, data_seed=-1, randpca=False):
    ### set paths
    model_type = "AE"
    ...
    ### Joint models
        ...
        DVAE_awa = ResE2D2((3, cropped_image_size_h, cropped_image_size_h), (3, cropped_image_size_h, cropped_image_size_h), int(z_dim/2), int(z_dim/2), 4, 1).to(device)
...
if __name__ == "__main__":
    """        
    python plot_img.py --dataset airbus --device 0 -l 1e-4 -n 299 -r 0.5 -k 0.0 -t 0.0 -z 80 -bs 64 --seed 1 -corpen 0.0 -vae ResBasedVAE -wt 80 -ht 112
    python plot_img.py --dataset airbus --device 7 -l 1e-4 -n 299 -r 0.0 -k 0.0 -t 0.1 -z 40 -bs 64 --seed 1 -corpen 0.0 -vae JointResBasedVAE -wt 80 -ht 112 -p True
    """
