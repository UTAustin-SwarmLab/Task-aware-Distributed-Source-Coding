'''
code modified from https://github.com/huytranvan2010/Mosaic_data_augmentation_YOLO/tree/main
'''
...
def random_crop_savebboxes(image_name, image_dir, label_dir, expected_h,
                           expected_w, min_area, min_visibility):
    """
...
def mosaic(image_file_list, image_dir, label_dir, output_image_dir, 
            output_label_dir, mo_w, mo_h, scale_x, scale_y, min_area, min_visibility):
    """
...
if __name__ == "__main__":
    ...
    for i in range(10000):
        ...
        mosaic(image_file_list, image_dir, label_dir, output_image_dir, 
            output_label_dir, mo_w, mo_h, scale_x, scale_y, min_area, min_visibility)
